...
#ifndef __biquad_faddfsub_3bkb__HH__
#define __biquad_faddfsub_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(biquad_faddfsub_3bkb) {
    ...
    SC_CTOR(biquad_faddfsub_3bkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
