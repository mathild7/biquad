...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x10 a1 W 0x0 "Data signal of a1" {{0 32 a1 W 0 "Bit 31 to 0 Data signal of a1"}}} {0x18 a2 W 0x0 "Data signal of a2" {{0 32 a2 W 0 "Bit 31 to 0 Data signal of a2"}}} {0x20 b0 W 0x0 "Data signal of b0" {{0 32 b0 W 0 "Bit 31 to 0 Data signal of b0"}}} {0x28 b1 W 0x0 "Data signal of b1" {{0 32 b1 W 0 "Bit 31 to 0 Data signal of b1"}}} {0x30 b2 W 0x0 "Data signal of b2" {{0 32 b2 W 0 "Bit 31 to 0 Data signal of b2"}}} {0x38 user_writing_V W 0x0 "Data signal of user_writing_V" {{0 1 user_writing_V W 0 "Bit 0 to 0 Data signal of user_writing_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {/home/hildeb47/proj/ECE1373_GhostSynth/mods/biquad/biquad.cpp}
if {$enable_xo_gen} {
